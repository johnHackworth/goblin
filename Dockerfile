...
COPY --chown=goblin:goblin packages/firefish-js/package.json packages/firefish-js/package.json
...
RUN corepack install -g pnpm@8.15.4
...
COPY --from=build /goblin/packages/firefish-js/node_modules /goblin/packages/firefish-js/node_modules
